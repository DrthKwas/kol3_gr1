...
class Diary(object):
    ...
    def __load_data(self, filename):
        ...
        return [Student(stud, [Subject(sub, [y for x, y in self.json_data[stud][sub].iteritems()]) for sub in
                               self.json_data[stud].keys()]) for stud in self.json_data.keys()]
                ...
                if current_student:
                    ...
                    while True:
                        ...
                        if ans == "1":
                            ...
                            print(
                                str(current_student.compute_subject_attendance(
                                    raw_input("Enter subject's name: "))) + " %")
                        elif ans == "5":
                            break
                        else:
